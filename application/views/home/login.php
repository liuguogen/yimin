...
<div style="width: 90%;height: 800px;display: flex;">
    ...
    <div style="flex: 2;">
        <div style="padding-bottom: 50px;margin-left: 28%;margin-top: 150px;background-color:rgba(0, 0, 0, 0.3);width: 80%;text-align: left;padding-top: 20px;margin-left: 50px;margin-right: 50px;">
