...
<form action="<?php echo site_url('Admin_controller/caseList') ?>" method="post">
...
<ul id="myTab" class="nav nav-tabs">
    <li class="active">
        ...
        <li>
        <a href="<?php echo site_url('Admin_controller/addCase') ?>">添加案例</a>
    </li>
</ul>
<table class="table table-striped table-bordered table-hover table-condensed">
    <tr>
    ...
    ?>
        <tr>
            ...
            <td>
                ...
                <a href="<?php echo site_url('Admin_controller/editCase?case_id='.$v['case_id']); ?>">编辑</a> |
                
               
                
                <a href="javascript:if(confirm('确定删除吗？'))location='<?php echo site_url('Admin_controller/delCase?case_id='.$v['case_id']) ?>'" >删除</a>
