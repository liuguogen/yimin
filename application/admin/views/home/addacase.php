...
<div class="bjy-admin-nav">
    ...
    &gt;
    <a href="<?php echo site_url('Admin_controller/caseList') ?>">案例列表</a>
    &gt;
    添加案例
</div>
...
<ul id="myTab" class="nav nav-tabs">
    <li class="">
        ...
        <li class="active">
        <a href="javascript:;">添加案例</a>
    </li>
</ul>
<!-- 导航栏结束 -->

<form class="form-inline" action="<?php echo site_url('Admin_controller/addCase') ?>"  method="post" enctype="multipart/form-data" onsubmit="return checksubmit()">
    <table class="table table-striped table-bordered table-hover table-condensed">
       <input type="hidden" name="case_id" class="form-control" value="<?php if(isset($data['case_id']) && $data['case_id']){ echo $data['case_id'];}else{echo '';} ?>" />
        <tr>
